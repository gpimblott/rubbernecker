...
storyFetcher.getAllStories = function (res, projects, callback) {
    ...
    var query = pivotalApi.aggregatorHelperAllProjects(projects,
        '/stories?fields=url,current_state,project_id,estimate,name,description,labels(name)&date_format=millis&limit=500&envelope=true&with_story_type=feature');
    pivotalApi.aggregateQuery(res, query, function (error, results) {
        ...
        debug("Retrieved all %s stories", stories.length);
...
storyFetcher.getAllStoriesWithStatus = function (res, status, projects, callback) {
    ...
    var query = pivotalApi.aggregatorHelperAllProjects(projects,
        '/stories?date_format=millis&limit=500&envelope=true&with_state=' + encodeURIComponent(status) + '&with_story_type=feature&fields=url,project_id,current_state,estimate,name,description,labels(name)');
    pivotalApi.aggregateQuery(res, query, function (error, results) {
        ...
        var stories = internals.extractStoriesFromResults(results);
        debug("Retrieved %s stories with status %s", stories.length, status);
 ...
 * @param callback Function to call with the result
 */
storyFetcher.getAllStoriesWithLabel = function (res, labels, projects, callback) {

    var query = pivotalApi.aggregatorHelperAllProjects(projects,
        '/stories?date_format=millis&limit=500&envelope=true&with_label=' + encodeURIComponent(label) + '&with_story_type=feature&fields=url,project_id,current_state,estimate,name,description,labels(name)');
    pivotalApi.aggregateQuery(res, query, function (error, results) {
        ...
        var stories = internals.extractStoriesFromResults(results);
        debug("Retrieved %s stories with label %s", stories.length, label);
...
storyFetcher.getAllStoriesWithoutLabels = function (res, labels, projects, callback) {
    ...
    var query = pivotalApi.aggregatorHelperAllProjects(projects,
        '/stories?date_format=millis&limit=500&envelope=true&filter=' + encodeURIComponent(filter)+ '&fields=url,project_id,current_state,estimate,name,description,labels(name)');
    pivotalApi.aggregateQuery(res, query, function (error, results) {
