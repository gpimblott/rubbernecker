...
storyFetcher.getAllStoriesUpdatedSince = function (res, dateSince, projects, callback) {
    ...
    var query = pivotalApi.aggregatorHelperAllProjects(projects,
        '/stories?date_format=millis&limit=500&envelope=true&updated_after=' + dateSince + '&fields=url,project_id,current_state,estimate,name,description,labels(name)');
    pivotalApi.aggregateQuery(res.app.get('pivotalApiKey'), query, function (error, results) {
...
storyFetcher.getAllStoriesCreatedSince = function (res, dateSince, projects, callback) {
    ...
    var query = pivotalApi.aggregatorHelperAllProjects(projects,
        '/stories?date_format=millis&limit=500&envelope=true&created_after=' + dateSince + '&fields=url,project_id,current_state,estimate,name,description,labels(name)');
    pivotalApi.aggregateQuery(res.app.get('pivotalApiKey'), query, function (error, results) {
